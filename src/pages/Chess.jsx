...
export default function Chess() {
  ...
  if (currentGame) {
    ...
    return (
      <div className="flex-1 flex flex-col h-screen p-6 font-sans overflow-y-auto relative">
        ...
        {/* SATRANÇ TAHTASI ALANI */}
        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
          <SpotlightCard 
            className="w-full max-w-[450px] mx-auto p-5 md:p-8 shadow-2xl flex flex-col items-center"
            particleCount={15}
            enableTilt={false}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-4">
            {rooms.length === 0 ? (
              <div className="py-16 bg-white/[0.02] border border-white/5 rounded-3xl text-center text-gray-500 font-bold text-sm shadow-inner backdrop-blur-sm">
              ...
              rooms.map(room => (
                <SpotlightCard 
                  key={room.id} 
                  className="p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-all shadow-lg group"
                  enableTilt={true}
                  clickEffect={true}
                >
        ...
        <div>
          ...
          <SpotlightCard className="p-6 shadow-xl" particleCount={10} enableTilt={false}>
